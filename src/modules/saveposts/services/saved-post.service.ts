...
export class SavedPostService {
  ...
  async savePost(
    ...
    const existing =
      await this.savedPostRepository.findByUserAndPost(
        userId,
        data.postId,
      );
  ...
  async unsavePost(
    ...
    return this.savedPostRepository.delete(
      userId,
      postId,
    );
  }
  ...
  async getSavedPosts(userId: string) {
    return this.savedPostRepository.findByUser(
      userId,
    );
  }
}