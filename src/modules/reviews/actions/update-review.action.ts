import { updateReviewSchema, reviewIdParamSchema } from "../validations/review.validation";
...
export async function updateReviewAction(
  ...
  return reviewService.updateReview(validatedReviewId, authUserId, validatedData);
}